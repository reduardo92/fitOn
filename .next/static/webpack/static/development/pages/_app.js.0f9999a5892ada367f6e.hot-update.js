...
var Styled = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].header(_templateObject(), function (props) {
  ...
  return props.topHead && props.topHead;
}, function (props) {
...
var Navbar = function Navbar() {
  ...
  var _useState4 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(null),
      topHead = _useState4[0],
      setTopHead = _useState4[1];
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    window.addEventListener('scroll', function () {
      if (window.scrollY > navheight) {
        setTopHead("".concat(navRef.current.firstElementChild.scrollHeight, "px"));
        setNavScroll(true);
      } else {
        setNavScroll(false);
        setTopHead(0);
...
//# sourceMappingURL=_app.js.0f9999a5892ada367f6e.hot-update.js.map